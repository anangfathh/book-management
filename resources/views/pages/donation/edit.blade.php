...
<form action="{{ route('donation.update', $bookDonation->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="publication_year" id="publication_year" class="form-control @error('publication_year') is-invalid @enderror" value="{{ $bookDonation->publication_year }}" required>
