            ...
            <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-3 xl:col-span-3">
                <div class="w-full relative p-4">
                    ...
                    <div class="w-full h-56 mx-auto  mb-4">
                        <input type="file" class="@error('image_path') is-invalid @enderror filepond h-56"
                            name="image_path" id="image_path" accept="image/png, image/jpeg, image/gif" />
                        @error('image_path')
                    ...
                    <div class="flex-auto p-0 md:p-4">
                        ...
                        <div id="pdf-path-field" class="form-group" style="display: none;">
                            ...
                            <input type="file" name="pdf_path" id="pdf_path"
                                class="form-control-file @error('pdf_path') is-invalid @enderror" required>
                            @error('pdf_path')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
